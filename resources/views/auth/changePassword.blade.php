...
<body class="font-sans bg-gray-100">
    <div class="flex items-center justify-center min-h-screen">
        <div class="p-8 mx-4 bg-white rounded shadow-md w-96">
            <h2 class="mb-6 text-2xl font-semibold text-gray-800">Change Password</h2>
            ...
            <form action="{{ route('password.reset.post') }}" method="POST">
                ...
                <!-- Submit Button -->
                <button type="submit"
                    class="w-full px-4 py-2 text-white transition duration-300 bg-blue-500 rounded-md hover:bg-blue-700">Change
                    Password</button>
            </form>
        </div>
    </div>
